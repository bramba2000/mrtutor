...
type Repository interface {
	...
	Create(ctx context.Context, tutor TutorFields, userId int) (Tutor, error)
	...
	// GetByUserID returns a tutor by user ID, or ErrNotFound if not found.
	GetByUserID(ctx context.Context, userId int) (Tutor, error)
}
